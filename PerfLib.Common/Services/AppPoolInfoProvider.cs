...
namespace PerfLib.Common.Services
{
    ...
    {
        public static Dictionary<string, int> GetProcessIdByAppPoolName()
        {
            var appPoolByProcessId = new Dictionary<string, int>();
            ...
            foreach (string instance in instances)
            {
                if (instance != "_Total")
                {
                    ...
                    {
                        appPoolByProcessId[parts[1]] = processId;
                    }
                }
            }

            return appPoolByProcessId;
        }
